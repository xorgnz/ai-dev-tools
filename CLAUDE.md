# Claude Root Entry Point

This file is the Claude-facing root entry point for this repository.
...
This root file is only for maintaining this repository. It is not the same as reusable guidance stored in `downstream/guidelines/models/claude.md` for downstream projects.
