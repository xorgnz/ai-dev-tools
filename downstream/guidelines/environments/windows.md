...
- When editing repository files from the Windows environment, preserve the repository's existing CRLF line endings instead of introducing LF-only rewrites.
