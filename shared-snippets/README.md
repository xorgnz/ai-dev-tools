...
Notes
- If a snippet needs environment- or toolset-specific detail, that detail likely belongs in an overlay under `downstream/environments/` or `downstream/toolsets/`, not in the snippet itself.
