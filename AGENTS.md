...
This root file is only for maintaining this repository. It is not the same as reusable guidance stored in `downstream/guidelines/codex.md` for downstream projects.
